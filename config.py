...
class Settings(BaseSettings):
    ...
    detection_model: str = os.getenv("DETECTION_MODEL", "gemini-2.5-flash")
    persona_model: str = os.getenv("PERSONA_MODEL", "gemini-2.5-flash")
    response_model: str = os.getenv("RESPONSE_MODEL", "gemini-2.5-flash")
    extraction_model: str = os.getenv("EXTRACTION_MODEL", "gemini-2.5-flash")
    judge_model: str = os.getenv("JUDGE_MODEL", "gemini-2.5-flash")
    factcheck_model: str = os.getenv("FACTCHECK_MODEL", "gemini-2.5-flash")
